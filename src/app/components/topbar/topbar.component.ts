    ...
    <div class="main-header navbar-fixed-top">
        <div class="header-menu">
            ...
            <div class="header-logo-wrapper">
                <img class="header-logo-image" src="./assets/imgs/logo.png">
            </div>
            <div class="header-nav-wrapper">
                <ul class="header-nav">
                    ...
                    <li class="header-nav-item">
                        <a routerLink="/">MENU<span class="fa fa-caret-down"></span></a>
                    </li>
                    <li class="header-nav-item">
                        <a routerLink="/kontakt" >KONTAKTDATEN</a>
                    </li>
                    <li class="header-nav-item">
                        <a routerLink="/bewertung">BEWERTUNG<span class="fa fa-caret-down"></span></a>
                    </li>
                </ul>
            </div>
            <div class="header-cart-wrapper">
                <div class="header-cart" (click)="toggleCartPopup($event)">
                    ...
                    <div class="header-cart-item">
                        <a href="">Warenkorb <span *ngIf="cart_num">( {{cart_num}} )</span><span class="fa fa-caret-down"></span></a>
                    </div>
                </div>
            </div>
        </div>
